...
async def atualizar_processo_datajud(
    ...
    try:
        ...
        # Gerar prazos automáticos baseados nos andamentos
...
# ============================================
# PRAZOS PROCESSUAIS - ENDPOINTS
# ============================================

@app.get("/api/admin/prazos")
...
@app.get("/api/admin/prazos/pendentes")
...
@app.get("/api/admin/prazos/resumo")
...
@app.get("/api/admin/processos/{processo_id}/prazos")
...
@app.post("/api/admin/processos/{processo_id}/prazos")
...
@app.put("/api/admin/prazos/{prazo_id}")
...
@app.post("/api/admin/prazos/{prazo_id}/concluir")
...
@app.post("/api/admin/prazos/{prazo_id}/cancelar")
...
@app.delete("/api/admin/prazos/{prazo_id}")
...
@app.post("/api/admin/processos/{processo_id}/gerar-prazos")
...
@app.get("/api/admin/clientes/{cadastro_id}/prazos")
