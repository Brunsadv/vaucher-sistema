...
# Endpoints de Admin (andamentos, mensagens, processos, contratos, parcelas, comprovantes)
# movidos para routes/admin_processos.py
...
# Endpoints duplicados de cliente (meus-processos, meus-contratos) removidos
# Versões principais estão na seção PORTAL DO CLIENTE acima
